...
class DQCNNPCA(nn.Module):
    ...
    def create_target_network(self):
        self.target_network = [DQCNNPCA(env=self.env, batch_sz=self.batch_size,
    ...
    def load_state_dict(self, state_dict):        
        if self.use_target_network:
            super(DQCNNPCA, self).load_state_dict(state_dict)
